			        ...
			        <form method="get" action="">
			        	...
			        	<?php 
			        		$payment_channels = array(
			        				['label'=>'Credit Card','id'=>'15','icon'=>asset("vendor/asset_payment/logocc.gif")],
			        				['label'=>'Mandiri Clickpay','id'=>'02','icon'=>asset("vendor/asset_payment/logo_mandiriclickpay.png")],
			        				['label'=>'Doku Wallet','id'=>'04','icon'=>asset("vendor/asset_payment/logo_dokuwallet.png")],
			        				['label'=>'Bank Transfer','id'=>'05','icon'=>asset("vendor/asset_payment/logo_atmbersama.jpg")]
			        			);
			        		...
			        		foreach($payment_channels as $k=>$payment_channel):
								...
								$inv = !Request::get("trans_id") ? $invoice : Request::get("trans_id");
			        	?>
					        				        		
					        		<a href='{{url(config("payment.doku.PAYMENT_PATH"))."?trans_id=".$inv."&payment_channel=".$payment_channel["id"]}}' class='payment_channel'> {{$payment_channel['label']}} 
					        			<span class='pull-right'>
											<img style="margin-top: -2px" src='{{asset("vendor/asset_payment/ic_arrow_right.png")}}'/>
										</span>
					        		</a>
