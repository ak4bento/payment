...
//Route::group(['middleware'=>['\Illuminate\Session\Middleware\StartSession'],'prefix'=>config('payment.doku.PAYMENT_PATH'),'namespace'=>$namespace], function () {
...
//});
Route::group(['prefix'=>config('payment.midtransPaymentPath'),'namespace'=>$namespace], function () {
    Route::post('/notification', ['uses' => 'MidtransController@status', 'as' => 'midtrans.notification']);
});